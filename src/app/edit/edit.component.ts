...
export class EditComponent implements OnInit {
	constructor(private dataService: DataService, private router: Router, private route: ActivatedRoute, private alert: MatSnackBar) {}
	...
	ngOnInit() {
		...
		this.dataService.getRandomProducts(this.id).subscribe((products: Product[]) => {
